...
async def run_attendance_tests():
    ...
    async with httpx.AsyncClient(base_url=BASE_URL, timeout=12.0) as client:
        # -------------------------------------------------------------
        # 1. Admin Authentication & Attendance Policy Configuration
        # -------------------------------------------------------------
        ...
        # Ensure maintenance mode is disabled initially
        await client.post("/admin/maintenance", headers=admin_headers, json={"maintenance_mode": False})

        # Configure Attendance Policies: 75% required, 10 min grace period
        ...
        # -------------------------------------------------------------
        # 2. Student Login (MUST NOT AUTOMATICALLY MARK ATTENDANCE)
        # -------------------------------------------------------------
        print("2. Testing Student Login (Verifying NO Auto-Attendance on Login)...")
        # Clear any existing in-memory attendance for clean test
        ...
        # -------------------------------------------------------------
        # 3. Student Generic Page / Dashboard Visit (NO ATTENDANCE)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 4. Student Enters Specific Laboratory During Active Session
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 5. Duplicate Prevention on Re-entry / Refresh
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 6. Student Attempts Entry into Non-Enrolled Laboratory
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 7. Student Attempts Entry into Lab with No Active Session
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 8. Student Manual Check-In Feature
        # -------------------------------------------------------------
        print("8. Testing Manual 'Check In to Active Lab' Endpoint...")
        # Check-in for active lab (nsa)
        ...
        # Check-in for inactive lab (adbms) -> must reject 400
        ...
        # -------------------------------------------------------------
        # 9. Student Attendance Dashboard & Threshold Status (No KTU)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 10. Faculty Authorization & Course Isolation
        # -------------------------------------------------------------
        print("10. Testing Faculty Authentication & Strict Course Isolation...")
        # Faculty Rakhi (assigned only to NSA)
        ...
        # Rakhi CANNOT access ADBMS roster (403 Forbidden)
        ...
        # -------------------------------------------------------------
        # 11. Faculty Manual Attendance Override & Audit Logging
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 12. Faculty Batch Update (Bulk Present & Bulk Absent)
        # -------------------------------------------------------------
        ...
        # -------------------------------------------------------------
        # 13. System Maintenance Mode & Cross-Role Isolation
        # -------------------------------------------------------------
